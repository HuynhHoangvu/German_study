  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "in-ue1", label: "Er hat sich in ___ Nachbarin verliebt. (die Nachbarin)", meaning: "phải lòng cô hàng xóm — Akkusativ", answer: "die" },
          { id: "in-ue2", label: "Das Problem besteht in ___ fehlenden Kommunikation. (die Kommunikation)", meaning: "nằm ở việc thiếu giao tiếp — Dativ", answer: "der" },
          { id: "in-ue3", label: "Der Staat investiert in ___ Bildung. (die Bildung)", meaning: "đầu tư vào giáo dục — Akkusativ", answer: "die" },
          { id: "in-ue4", label: "Sie kennt sich in ___ Gegend gut aus. (die Gegend)", meaning: "rành khu vực này — Dativ", answer: "der" },
          { id: "in-ue5", label: "Die Familie ist in ___ Schwierigkeiten geraten. (die Schwierigkeiten, Pl.)", meaning: "rơi vào khó khăn — Akkusativ", answer: "die" },
        ],
      },
    ],
  },
