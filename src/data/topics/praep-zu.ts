  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "zu-ue1", label: "Stress führt oft zu Problemen.", meaning: "dẫn đến vấn đề" },
          { id: "zu-ue2", label: "Jeder kann zum Umweltschutz beitragen.", meaning: "góp phần — zum = zu + dem" },
          { id: "zu-ue3", label: "Ich gratuliere dir zur bestandenen Prüfung!", meaning: "chúc mừng — zur = zu + der" },
          { id: "zu-ue4", label: "Pünktlichkeit gehört zu den wichtigsten Tugenden.", meaning: "thuộc về những đức tính" },
          { id: "zu-ue5", label: "Er neigt dazu, alles zu dramatisieren.", meaning: "có xu hướng — dạng đại từ" },
        ],
      },
    ],
  },
