  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "ueber-ue1", label: "Ich ärgere mich über den Lärm.", meaning: "bực mình vì tiếng ồn" },
          { id: "ueber-ue2", label: "Der Bewerber verfügt über viel Erfahrung.", meaning: "có nhiều kinh nghiệm" },
          { id: "ueber-ue3", label: "Ich denke über einen Jobwechsel nach.", meaning: "suy nghĩ về đổi việc" },
          { id: "ueber-ue4", label: "Sie freut sich über die gute Note.", meaning: "vui vì điểm tốt (đã xảy ra)" },
          { id: "ueber-ue5", label: "Er hat die Kontrolle über die Situation verloren.", meaning: "mất kiểm soát tình hình" },
        ],
      },
    ],
  },
