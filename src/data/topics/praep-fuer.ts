  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        meaning: "luyện tập",
        children: [
          { id: "fuer-ue1", label: "Ich interessiere mich ___ Kunst.", meaning: "quan tâm đến nghệ thuật", answer: "für" },
          { id: "fuer-ue2", label: "Ich halte den Vorschlag ___ sinnvoll.", meaning: "cho rằng đề xuất hợp lý", answer: "für" },
          { id: "fuer-ue3", label: "Wer sorgt ___ die Kinder?", meaning: "ai lo cho bọn trẻ", answer: "für" },
          { id: "fuer-ue4", label: "Sie sorgt sich ___ ihre Zukunft.", meaning: "lo lắng cho tương lai — giới từ nào?", answer: "um" },
          { id: "fuer-ue5", label: "Gute Sprachkenntnisse sind die Voraussetzung ___ diese Stelle.", meaning: "điều kiện cho vị trí này", answer: "für" },
        ],
      },
    ],
  },
