  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "bei-ue1", label: "Kannst du mir bei den Hausaufgaben helfen?", meaning: "giúp làm bài tập" },
          { id: "bei-ue2", label: "Ich bedanke mich bei Ihnen für die Hilfe.", meaning: "cảm ơn quý vị" },
          { id: "bei-ue3", label: "Ich habe mich beim Vermieter beschwert.", meaning: "khiếu nại với chủ nhà — beim = bei + dem" },
          { id: "bei-ue4", label: "Bei Fragen stehe ich Ihnen gern zur Verfügung.", meaning: "nếu có thắc mắc" },
          { id: "bei-ue5", label: "Ich habe mich bei mehreren Firmen beworben.", meaning: "nộp đơn ở nhiều công ty" },
        ],
      },
    ],
  },
