  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        label: "Beispielsätze mit Konnektoren",
        meaning: "câu ví dụ có liên từ",
        children: [
          { id: "ue-kon-1", label: "Ich lerne Deutsch, weil ich hier arbeiten möchte.", meaning: "vì (động từ cuối câu)" },
          { id: "ue-kon-2", label: "Er war müde, trotzdem arbeitete er weiter.", meaning: "dù vậy (đứng vị trí 1)" },
          { id: "ue-kon-3", label: "Obwohl er müde war, arbeitete er weiter.", meaning: "mặc dù (động từ cuối câu)" },
          { id: "ue-kon-4", label: "Ich spare Geld, indem ich weniger online bestelle.", meaning: "bằng cách" },
          { id: "ue-kon-5", label: "Ich erkläre es noch einmal, damit alle es verstehen.", meaning: "để (khác chủ ngữ)" },
          { id: "ue-kon-6", label: "Es regnete stark, sodass das Spiel abgesagt wurde.", meaning: "khiến cho" },
          { id: "ue-kon-7", label: "Nachdem ich gegessen hatte, ging ich spazieren.", meaning: "sau khi" },
          { id: "ue-kon-8", label: "Beeil dich, sonst verpassen wir den Bus.", meaning: "nếu không thì" },
          { id: "ue-kon-9", label: "Er kommt nicht heute, sondern morgen.", meaning: "mà là" },
          { id: "ue-kon-10", label: "Aufgrund der hohen Kosten wurde das Projekt gestoppt.", meaning: "do (+ Genitiv)" },
        ],
      },
    ],
  },
