  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "von-ue1", label: "Meine Entscheidung hängt von dem Gehalt ab.", meaning: "phụ thuộc vào lương" },
          { id: "von-ue2", label: "Was hältst du von diesem Vorschlag?", meaning: "nghĩ sao về đề xuất" },
          { id: "von-ue3", label: "Beide Seiten profitieren von der Zusammenarbeit.", meaning: "hưởng lợi từ hợp tác" },
          { id: "von-ue4", label: "Ich gehe davon aus, dass alle kommen.", meaning: "tôi cho rằng — dạng đại từ davon" },
          { id: "von-ue5", label: "Der Arzt hat mir von dieser Behandlung abgeraten.", meaning: "khuyên đừng theo liệu pháp" },
        ],
      },
    ],
  },
