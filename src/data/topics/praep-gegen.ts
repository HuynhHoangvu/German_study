  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "gegen-ue1", label: "Tausende protestieren gegen die Reform.", meaning: "phản đối cuộc cải cách" },
          { id: "gegen-ue2", label: "Das verstößt gegen die Hausordnung.", meaning: "vi phạm nội quy" },
          { id: "gegen-ue3", label: "Bewegung ist das beste Mittel gegen Stress.", meaning: "biện pháp chống căng thẳng" },
          { id: "gegen-ue4", label: "Wir haben uns gegen einen Umzug entschieden.", meaning: "quyết định không chuyển nhà" },
          { id: "gegen-ue5", label: "Die Stadt kämpft gegen die Luftverschmutzung.", meaning: "chống ô nhiễm không khí" },
        ],
      },
    ],
  },
