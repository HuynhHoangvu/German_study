    ...
    children: [
      {
        ...
        children: [
          ...
          { id: "einbuergerung", label: "die Einbürgerung", meaning: "nhập quốc tịch", note: "ein + Bürger (công dân) + ung: trở thành công dân." },
      ...
      },
      {
        ...
        children: [
          ...
          { id: "gleichstellung", label: "die Gleichstellung von Mann und Frau", meaning: "bình đẳng nam nữ", synonyms: ["die Gleichberechtigung"] },
      ...
      },
      {
        ...
        children: [
          ...
          { id: "gemeinnuetzig", label: "gemeinnützig arbeiten", meaning: "làm việc phi lợi nhuận", note: "gemein (chung) + nützig (có ích): vì lợi ích cộng đồng." },
        ],
      },
      {
        id: "demografie",
        ...
        children: [
          ...
          { id: "generationenvertrag", label: "der Generationenvertrag", meaning: "hợp đồng liên thế hệ (bảo hiểm xã hội)", note: "thế hệ đi làm đóng góp nuôi thế hệ nghỉ hưu." },
