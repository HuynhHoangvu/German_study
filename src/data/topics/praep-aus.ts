  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "aus-ue1", label: "Die Prüfung besteht aus vier Teilen.", meaning: "gồm bốn phần" },
          { id: "aus-ue2", label: "Der Kunde besteht auf einer Rückerstattung.", meaning: "khăng khăng đòi hoàn tiền — bestehen auf + Dativ" },
          { id: "aus-ue3", label: "Aus diesem Grund kündige ich den Vertrag.", meaning: "vì lý do này" },
          { id: "aus-ue4", label: "Man sollte aus seinen Fehlern lernen.", meaning: "rút kinh nghiệm từ sai lầm" },
          { id: "aus-ue5", label: "Aus gesundheitlichen Gründen kann ich nicht kommen.", meaning: "vì lý do sức khỏe" },
        ],
      },
    ],
  },
