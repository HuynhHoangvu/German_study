  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        meaning: "luyện tập",
        children: [
          { id: "vor-ue1", label: "Viele haben Angst ___ dem Fliegen.", meaning: "sợ đi máy bay", answer: "vor" },
          { id: "vor-ue2", label: "Die Creme schützt die Haut ___ der Sonne.", meaning: "bảo vệ da khỏi nắng", answer: "vor" },
          { id: "vor-ue3", label: "Ärzte warnen ___ den Folgen von Stress.", meaning: "cảnh báo về hậu quả căng thẳng", answer: "vor" },
          { id: "vor-ue4", label: "Ich habe großen Respekt ___ ihrer Leistung.", meaning: "nể thành tích của cô ấy", answer: "vor" },
          { id: "vor-ue5", label: "Sie fürchtet sich vor ___ Dunkelheit. (die Dunkelheit)", meaning: "sợ bóng tối — điền mạo từ Dativ", answer: "der" },
        ],
      },
    ],
  },
