  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "unter-ue1", label: "Viele leiden unter dem hohen Leistungsdruck.", meaning: "khổ vì áp lực (hoàn cảnh)" },
          { id: "unter-ue2", label: "Sie leidet an einer chronischen Krankheit.", meaning: "mắc bệnh mãn tính — leiden an + Dativ" },
          { id: "unter-ue3", label: "Was verstehen Sie unter dem Begriff Integration?", meaning: "hiểu khái niệm đó là gì" },
          { id: "unter-ue4", label: "Er steht seit Wochen unter enormem Stress.", meaning: "chịu căng thẳng lớn" },
          { id: "unter-ue5", label: "In der Probezeit muss man sein Können unter Beweis stellen.", meaning: "chứng minh năng lực" },
        ],
      },
    ],
  },
