  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "auf-ue1", label: "Ich freue mich auf das Wochenende.", meaning: "mong chờ cuối tuần" },
          { id: "auf-ue2", label: "Achte bitte auf den Verkehr!", meaning: "chú ý giao thông" },
          { id: "auf-ue3", label: "Der Kunde besteht auf einer Rückerstattung.", meaning: "khăng khăng đòi (+ Dativ)" },
          { id: "auf-ue4", label: "Ich bereite mich auf die Prüfung vor.", meaning: "chuẩn bị cho kỳ thi" },
          { id: "auf-ue5", label: "Jeder hat Anspruch auf bezahlten Urlaub.", meaning: "quyền nghỉ phép có lương" },
          { id: "auf-ue6", label: "Es kommt ganz auf das Wetter an.", meaning: "tùy vào thời tiết" },
        ],
      },
    ],
  },
