  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "um-ue1", label: "Ich bewerbe mich um eine Stelle.", meaning: "xin một vị trí" },
          { id: "um-ue2", label: "Ich bitte Sie um eine kurze Rückmeldung.", meaning: "xin phản hồi ngắn" },
          { id: "um-ue3", label: "In dem Text geht es um den Klimawandel.", meaning: "bài viết nói về" },
          { id: "um-ue4", label: "Die Eltern sorgen sich um ihre Kinder.", meaning: "lo lắng cho con cái" },
          { id: "um-ue5", label: "Wer kümmert sich um die Organisation?", meaning: "ai lo việc tổ chức" },
        ],
      },
    ],
  },
