  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "ue-adj-1", label: "stolz auf seine Leistung", meaning: "tự hào về thành tích" },
          { id: "ue-adj-2", label: "zufrieden mit dem Ergebnis", meaning: "hài lòng với kết quả" },
          { id: "ue-adj-3", label: "abhängig von der Meinung anderer", meaning: "phụ thuộc vào ý kiến người khác" },
          { id: "ue-adj-4", label: "interessiert an einer Stelle", meaning: "quan tâm đến một vị trí" },
          { id: "ue-adj-5", label: "verantwortlich für das Team", meaning: "chịu trách nhiệm về nhóm" },
          { id: "ue-adj-6", label: "bereit zu einem Kompromiss", meaning: "sẵn sàng thỏa hiệp" },
          { id: "ue-adj-7", label: "beliebt bei jungen Leuten", meaning: "được giới trẻ yêu thích" },
          { id: "ue-adj-8", label: "geschützt vor der Sonne", meaning: "được bảo vệ khỏi ánh nắng" },
          { id: "ue-adj-9", label: "gut in Mathematik", meaning: "giỏi toán" },
          { id: "ue-adj-10", label: "glücklich über die gute Nachricht", meaning: "hạnh phúc vì tin tốt" },
        ],
      },
    ],
  },
