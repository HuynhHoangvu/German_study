  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        meaning: "luyện tập",
        children: [
          { id: "nach-ue1", label: "Ich suche ___ einer Wohnung.", meaning: "tìm một căn hộ", answer: "nach" },
          { id: "nach-ue2", label: "Ich möchte mich ___ den Öffnungszeiten erkundigen.", meaning: "hỏi về giờ mở cửa", answer: "nach" },
          { id: "nach-ue3", label: "Der Preis richtet sich ___ der Größe.", meaning: "giá tùy theo diện tích", answer: "nach" },
          { id: "nach-ue4", label: "Die Nachfrage ___ Fachkräften steigt.", meaning: "nhu cầu nhân lực lành nghề", answer: "nach" },
          { id: "nach-ue5", label: "Ich sehne mich ___ meiner Heimat.", meaning: "nhớ quê hương", answer: "nach" },
        ],
      },
    ],
  },
