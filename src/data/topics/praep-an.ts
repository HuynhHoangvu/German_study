  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        note: "So sánh mạo từ để thấy rõ khác biệt Akkusativ và Dativ.",
        children: [
          { id: "an-ue1", label: "Ich denke oft an die Zukunft.", meaning: "nghĩ về tương lai — Akkusativ" },
          { id: "an-ue2", label: "Ich nehme an dem Kurs teil.", meaning: "tham gia khóa học — Dativ" },
          { id: "an-ue3", label: "Sie leidet an einer schweren Krankheit.", meaning: "mắc bệnh nặng — Dativ" },
          { id: "an-ue4", label: "Erinnerst du dich an den Abend?", meaning: "nhớ buổi tối đó — Akkusativ" },
          { id: "an-ue5", label: "Ich arbeite an einem neuen Projekt.", meaning: "đang làm dự án mới — Dativ" },
          { id: "an-ue6", label: "Wenden Sie sich bitte an das Sekretariat.", meaning: "liên hệ văn phòng — Akkusativ" },
        ],
      },
    ],
  },
