  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "mit-ue1", label: "Ich beschäftige mich mit diesem Thema.", meaning: "nghiên cứu chủ đề này" },
          { id: "mit-ue2", label: "Man muss lernen, mit Kritik umzugehen.", meaning: "ứng xử với phê bình" },
          { id: "mit-ue3", label: "Wir rechnen mit steigenden Preisen.", meaning: "lường trước giá tăng" },
          { id: "mit-ue4", label: "Er hat mit dem Rauchen aufgehört.", meaning: "đã bỏ thuốc lá" },
          { id: "mit-ue5", label: "Ich beschäftige mich mit dem Thema.", meaning: "mạo từ ở Dativ" },
        ],
      },
    ],
  },
