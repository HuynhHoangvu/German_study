  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        note: "Chạm vào từng nhánh và điền giới từ còn thiếu để ghi nhớ lâu hơn.",
        children: [
          { id: "ue-akk-1", label: "sich bewerben ___ eine Stelle", meaning: "nộp đơn xin một vị trí", answer: "um" },
          { id: "ue-akk-2", label: "sich freuen ___ die Reise nächste Woche", meaning: "mong chờ chuyến đi tuần tới", answer: "auf" },
          { id: "ue-akk-3", label: "sich ärgern ___ den Lärm", meaning: "bực mình vì tiếng ồn", answer: "über" },
          { id: "ue-akk-4", label: "sich interessieren ___ Kunst", meaning: "quan tâm đến nghệ thuật", answer: "für" },
          { id: "ue-akk-5", label: "sich gewöhnen ___ das neue Leben", meaning: "làm quen với cuộc sống mới", answer: "an" },
          { id: "ue-akk-6", label: "protestieren ___ die Reform", meaning: "phản đối cuộc cải cách", answer: "gegen" },
          { id: "ue-akk-7", label: "sich verlieben ___ jemanden", meaning: "phải lòng ai đó", answer: "in" },
          { id: "ue-akk-8", label: "verzichten ___ das Auto", meaning: "từ bỏ xe hơi", answer: "auf" },
          { id: "ue-akk-9", label: "sich kümmern ___ die Kinder", meaning: "chăm lo cho bọn trẻ", answer: "um" },
          { id: "ue-akk-10", label: "nachdenken ___ einen Jobwechsel", meaning: "suy nghĩ về việc đổi việc", answer: "über" },
        ],
      },
    ],
  },
