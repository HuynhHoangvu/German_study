  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        label: "Beispielsätze mit Redemitteln",
        meaning: "câu ví dụ có mẫu câu",
        children: [
          { id: "ue-rm-1", label: "In meiner Präsentation geht es um das Thema Umwelt.", meaning: "mở đầu bài trình bày" },
          { id: "ue-rm-2", label: "Meiner Meinung nach sollte der Nahverkehr billiger sein.", meaning: "theo ý tôi" },
          { id: "ue-rm-3", label: "Zusammenfassend lässt sich sagen, dass die Vorteile überwiegen.", meaning: "tóm lại có thể nói" },
          { id: "ue-rm-4", label: "Sehr geehrte Damen und Herren,", meaning: "lời chào thư trang trọng" },
          { id: "ue-rm-5", label: "Ich wäre Ihnen sehr dankbar, wenn Sie mir antworten könnten.", meaning: "biết ơn" },
          { id: "ue-rm-6", label: "Mit freundlichen Grüßen", meaning: "lời chào cuối thư" },
          { id: "ue-rm-7", label: "Das sehe ich etwas anders, weil …", meaning: "phản đối lịch sự" },
          { id: "ue-rm-8", label: "Ein gutes Beispiel dafür ist die Situation in Hanoi.", meaning: "ví dụ điển hình" },
          { id: "ue-rm-9", label: "Können wir uns darauf einigen, dass wir um 15 Uhr anfangen?", meaning: "thống nhất" },
          { id: "ue-rm-10", label: "Die Grafik zeigt die Entwicklung der Mietpreise.", meaning: "biểu đồ cho thấy" },
        ],
      },
    ],
  },
