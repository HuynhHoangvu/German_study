...
const topic: Topic = {
  ...
  root: {
    ...
    children: [
      ...
      {
        id: "uebung-grammatik",
        label: "Übung: Struktur erkennen",
        meaning: "Luyện tập: điền dạng đúng",
        children: [
          { id: "ue-gr-1", label: "Der Antrag muss bis Freitag eingereicht ___.", meaning: "bị động với Modalverb", answer: "werden" },
          { id: "ue-gr-2", label: "Wenn ich mehr Zeit ___, würde ich mehr lesen.", meaning: "Konjunktiv II của haben", answer: "hätte" },
          { id: "ue-gr-3", label: "___ Sie mir bitte kurz helfen?", meaning: "đề nghị lịch sự (können)", answer: "Könnten" },
          { id: "ue-gr-4", label: "Die Frau, ___ ich geholfen habe, hat sich bedankt.", meaning: "đại từ quan hệ Dativ giống cái", answer: "der" },
          { id: "ue-gr-5", label: "Die Kinder, ___ wir helfen, lernen schnell.", meaning: "đại từ quan hệ Dativ số nhiều", answer: "denen" },
          { id: "ue-gr-6", label: "___ des schlechten Wetters fiel das Fest aus.", meaning: "do (+ Genitiv)", answer: "Wegen" },
          { id: "ue-gr-7", label: "___ des Regens gingen wir spazieren.", meaning: "bất chấp (+ Genitiv)", answer: "Trotz" },
          { id: "ue-gr-8", label: "Ich habe mit dem ___ gesprochen. (der Kollege)", meaning: "n-Deklination", answer: "Kollegen" },
          { id: "ue-gr-9", label: "Das Problem lässt ___ leicht lösen.", meaning: "dạng thay thế bị động", answer: "sich" },
          { id: "ue-gr-10", label: "Die ___ Mieten sind ein Problem. (steigen, Partizip I)", meaning: "phân từ I làm tính từ", answer: "steigenden" },
        ],
      },
    ],
  },
