  ...
  root: {
    ...
    children: [
      ...
      },
      {
        ...
        note: "Câu ví dụ hoàn chỉnh — tất cả đều đi với Dativ.",
        children: [
          { id: "ue-dat-1", label: "sich beschäftigen mit einem Thema", meaning: "nghiên cứu một chủ đề" },
          { id: "ue-dat-2", label: "abhängen von dem Wetter", meaning: "phụ thuộc vào thời tiết" },
          { id: "ue-dat-3", label: "führen zu einem Problem", meaning: "dẫn đến một vấn đề" },
          { id: "ue-dat-4", label: "suchen nach einer Wohnung", meaning: "tìm một căn hộ" },
          { id: "ue-dat-5", label: "Angst haben vor der Prüfung", meaning: "sợ kỳ thi" },
          { id: "ue-dat-6", label: "teilnehmen an einem Kurs", meaning: "tham gia một khóa học" },
          { id: "ue-dat-7", label: "leiden unter dem Lärm", meaning: "chịu đựng tiếng ồn" },
          { id: "ue-dat-8", label: "bestehen aus vier Teilen", meaning: "gồm bốn phần" },
          { id: "ue-dat-9", label: "sich bedanken bei den Kollegen", meaning: "cảm ơn các đồng nghiệp" },
          { id: "ue-dat-10", label: "beitragen zu dem Umweltschutz", meaning: "góp phần bảo vệ môi trường" },
        ],
      },
    ],
  },
